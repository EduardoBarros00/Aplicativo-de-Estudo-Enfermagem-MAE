...
export const subjects: Subject[] = [
  ...
  },
  {
    id: "desabilidade",
    icon: "♿",
    title: "Desabilidade Funcional",
    color: "purple",
    text: "Autonomia, mobilidade, atividades de vida diária, dispositivos de apoio, segurança e inclusão.",
    image: "/desabilidade-funcional-hero.webp",
    lessons: [
      { id: "des-funcionalidade", title: "Desabilidade funcional — visão geral", duration: "16 min", minutes: 16, goal: "Compreender como limitações motoras, sensoriais ou cognitivas podem afetar atividades e participação sem reduzir a pessoa ao diagnóstico.", steps: ["Identificar quais atividades ficaram mais difíceis e quais capacidades permanecem preservadas.", "Observar fatores pessoais, ambientais e sociais que aumentam ou reduzem a limitação funcional.", "Planejar o apoio a partir das necessidades reais, preferências e objetivos da pessoa."], image: "/desabilidade-funcional-hero.webp", tip: "Avalie capacidades preservadas e necessidades reais; a pessoa não deve ser definida apenas pela limitação funcional." },
      { id: "des-avd", title: "AVDs e AIVDs", duration: "18 min", minutes: 18, goal: "Reconhecer atividades básicas e instrumentais de vida diária e identificar o nível de ajuda necessário.", steps: ["Observar higiene, vestir-se, alimentação, uso do banheiro, transferências e mobilidade.", "Considerar também preparo de refeições, compras, organização de medicamentos, transporte e outras atividades instrumentais.", "Registrar o que a pessoa realiza sozinha, com supervisão ou com ajuda, evitando substituir capacidades preservadas."], image: "/icon-desabilidade-avd.svg" },
      { id: "des-mobilidade", title: "Mobilidade e dispositivos de apoio", duration: "18 min", minutes: 18, goal: "Diferenciar bengala, muletas, andador e cadeira de rodas e reconhecer princípios de uso seguro.", steps: ["Confirmar se o dispositivo é adequado à pessoa e verificar integridade, altura e freios quando aplicável.", "Manter o percurso livre, favorecer calçado seguro e respeitar o ritmo da pessoa.", "Comunicar dor, tontura, instabilidade, falha do equipamento ou mudança da capacidade funcional."], image: "/icon-desabilidade-mobilidade.svg", tip: "O dispositivo deve ser escolhido e ajustado conforme avaliação profissional e necessidade individual." },
      { id: "des-transferencias", title: "Transferências seguras", duration: "16 min", minutes: 16, goal: "Organizar transferências entre leito, cadeira e outras superfícies com segurança para a pessoa e para o cuidador.", steps: ["Explicar o movimento, avaliar colaboração e preparar o destino antes de iniciar.", "Travar cadeira ou leito quando indicado, ajustar apoios e solicitar ajuda ou equipamento de transferência se necessário.", "Evitar tração pelos braços, proteger a própria ergonomia e interromper diante de dor, instabilidade ou risco."], image: "/icon-desabilidade-mobilidade.svg" },
      { id: "des-autonomia", title: "Autonomia e ajuda proporcional", duration: "15 min", minutes: 15, goal: "Apoiar a independência possível sem abandonar segurança, dignidade e participação.", steps: ["Perguntar como a pessoa prefere realizar a atividade e que ajuda considera necessária.", "Dar tempo e adaptar o ambiente antes de assumir a tarefa.", "Oferecer apenas o apoio necessário e reavaliar quando a capacidade funcional mudar."], image: "/icon-desabilidade-avd.svg" },
      { id: "des-seguranca", title: "Prevenção de quedas e lesões", duration: "17 min", minutes: 17, goal: "Identificar barreiras ambientais e fatores pessoais que aumentam risco de queda ou lesão.", steps: ["Observar obstáculos, iluminação, tapetes, altura do leito, freios, apoios e acesso à campainha.", "Considerar força, equilíbrio, visão, sensibilidade, dor, tontura e uso de dispositivos.", "Aplicar as medidas previstas no plano de cuidado e comunicar incidentes ou quase quedas."], image: "/desabilidade-acessibilidade.webp" },
      { id: "des-inclusao", title: "Comunicação, inclusão e acessibilidade", duration: "15 min", minutes: 15, goal: "Promover comunicação respeitosa, acessibilidade e participação ativa da pessoa no cuidado.", steps: ["Falar diretamente com a pessoa e perguntar qual forma de comunicação facilita sua participação.", "Garantir acesso a óculos, aparelhos auditivos, bengala, cadeira de rodas, comunicadores ou outros recursos pessoais.", "Evitar infantilização e pressupostos; confirmar compreensão e respeitar escolhas dentro das condições de segurança."], image: "/icon-desabilidade-seguranca.svg", tip: "A pessoa é a principal referência sobre seu próprio modo de realizar atividades e utilizar recursos de apoio." },
    ],
  },
];
